...
var jamapi = {
  getMusic (location, radius) {
    ...
    var url = `http://api.jambase.com/events?zipCode=${location}&radius=${radius}&startDate=${startDate}T20%3A00%3A00&endDate=${endDate}T20%3A00%3A00&page=0&api_key=wd5jqdk3hqxdeue6f6ba782m`
