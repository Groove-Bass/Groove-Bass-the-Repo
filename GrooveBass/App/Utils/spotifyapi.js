var spotifyapi = {
  ...
  getArtist(artists) {
    ...
    for (var i = 0; i < artists.length; i++) {
      let url = `https://api.spotify.com/v1/search?q=${artists[i]['Name']}&type=artist&access_token=BQAKDmsywRa_OFrA3FpNWNw7SKM8bD8_VDSsLz6ajLdcseMNZkkMBxjDrAFIT3Zhn9ahNeTPrI7uIULOD-l51TjieBr7t-Qu-2qg3QdCuzyfxunwbPZCRHtQ_DMjHMxI5MjxcDOvnWL15-b3IT7C3Iq3`
      ...
      .then((data) => {
        ...
        let url2 = `https://api.spotify.com/v1/artists/${data.id}/top-tracks?country=SE&access_token=BQAKDmsywRa_OFrA3FpNWNw7SKM8bD8_VDSsLz6ajLdcseMNZkkMBxjDrAFIT3Zhn9ahNeTPrI7uIULOD-l51TjieBr7t-Qu-2qg3QdCuzyfxunwbPZCRHtQ_DMjHMxI5MjxcDOvnWL15-b3IT7C3Iq3`
